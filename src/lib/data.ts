...
export const research = [
	...
	{ role: 'Unsupervised Learning Theory/Agentic Data Analysis', company: "Verma Lab @ Columbia", period: 'Jan 2024 - Jan 2025', description: 'Explored dimensionality reduction theory. Realized I am not cut out to be a theoretician and began working on agentic data analysis and optimized deployment of unsueprvised learning algorithms in a webapp.' },
...
export const projects = [
	...
	{ name: 'Ixion', description: 'Co-developed withixion.com, an AI-powered lab management software currently being used/adopted by 3 Columbia University labs.', tech: 'Django, Python, NextJS, AWS', link: 'https://withixion.com/' },
];
